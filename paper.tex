...
% This section will discuss the common methods used to create trading neural networks. There are two general kinds of data which can be fed into stock trading neural networks, which in turn, create two general categories of trading algorithms. The first kind takes numeric information about a stock and its price history. The second kind takes text information about a stock and its related news. Let's call the first type ``technical traders'' and the second type ``news traders.''
% \subsection{Technical Traders}
% Technical traders use time-series data
Many neural network structures and methods have been used to create trading algorithms. Common types include: 
\begin{itemize}
    \item Recurrent Neural Networks (RNNs) \cite{Gu2020}.
    \begin{itemize}
        \item LSTMs \cite{Gu2020}\cite{Chen2017}.
        \item LSTMs with sentiment analysis \cite{Gu2020}\cite{Mehta2021}.
    \end{itemize}
    \item Convolutional Neural Networks (CNNs) \cite{Gu2020}\cite{Sezer2018}\cite{Shi2020}.
